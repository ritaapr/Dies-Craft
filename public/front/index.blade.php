                        ...
                        <div class="navbar-nav ms-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    >
                                    <a
                                        href="property-type.html"
                                        class="dropdown-item"
                                        >Strap Masker</a
                                    >
                                    <a
                                        href="property-agent.html"
                                        class="dropdown-item"
                                        >Strap Phone</a
                                    >
                                    <a
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    <select class="form-select border-0 py-3">
                                        ...
                                        <option value="2">Scrab Masker</option>
                                        <option value="3">Gantungan HP</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select class="form-select border-0 py-3">
                            ...
                            <div class="row g-4">
                                    ...
                                    >
                                        ...
                                        <div class="p-4 pb-0">
                                            <a class="d-block h5 mb-2" href=""
                                                >Sunday Market Caruban</a
                                            >
                                            <p>
                                                <i
                                                    class="fa fa-map-marker-alt text-primary me-2"
                                                ></i
                                                >Jl. Mt. Haryono No.58-54, Caruban, Krajan, Kec. Mejayan, Kabupaten Madiun
                                            </p>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="p-4 pb-0">
                                            <a class="d-block h5 mb-2" href=""
                                                >Sunday Market Jombang</a
                                            >
                                            <p>
                                                <i
                                                    class="fa fa-map-marker-alt text-primary me-2"
                                                ></i
                                                >Jl. KH. Wahid Hasyim No.136 A, Kepanjen, Kec. Jombang, Kabupaten Jombang
                                            </p>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="p-4 pb-0">
                                            ...
                                            <a class="d-block h5 mb-2" href=""
                                                >Dies.craft beads store</a
                                            >
                                            <p>
                                                <i
                                                    class="fa fa-map-marker-alt text-primary me-2"
                                                ></i
                                                >Jl. Mojopahit No.52, Winongo, Kec. Manguharjo, Kota Madiun, Jawa Timur
                                            </p>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="p-4 pb-0">
                                            ...
                                            <a class="d-block h5 mb-2" href=""
                                                >Sunday Market Nganjuk</a
                                            >
                                            <p>
                                                <i
                                                    class="fa fa-map-marker-alt text-primary me-2"
                                                ></i
                                                >Alun-Alun Nganjuk Mangundikaran, Mangun Dikaran, Kec. Nganjuk, Kabupaten Nganjuk
                                            </p>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div class="p-4 pb-0">
                                            ...
                                            <p>
                                                ...
                                                ></i
                                                >Taman Hijau 
                                                Jl. Raya Kediri - Plosoklaten Jl. Erlangga No.163, Dadapan, Sukorejo, Kec. Ngasem, Kabupaten Kediri
                                            </p>
                                        </div>
                                        ...
                                        <div class="p-4 pb-0">
                                            ...
                                            <p>
                                                <i
                                                    class="fa fa-map-marker-alt text-primary me-2"
                                                ></i
                                                >Pasar Sari Jarang Sari, Lolawang, Kec. Ngoro, Kabupaten Mojokerto, Jawa Timur
                                            </p>
                                        </div>
                                    </div>
                                </div>
