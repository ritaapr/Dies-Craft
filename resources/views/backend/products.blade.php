									...
									<tbody>
										@forelse ($products as $product)
											<tr>
												...
												<!-- Foto Produk -->
												<td>
													<img src="{{ asset('storage/foto_produk/' . $product->foto_produk) }}" class="img-thumbnail" width="50" alt="{{ $product->nama_produk }}">
												</td>

												<!-- Nama Produk -->
												<td><a href="#">{{ $product->nama_produk }}</a></td>
												...
												<td>
													...
													@else
														<svg class="text-danger-500 h-6 w-6 text-danger" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
															<path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m6-4l-6 8"></path>
														</svg>
													@endif
												</td>
												...
												<!-- Aksi -->
												<td>
													<a href="{{ route('products.edit', $product->id_produk) }}" class="text-primary">
